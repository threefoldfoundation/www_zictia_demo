<template>
  <section class="bg-blue-950">
    <div v-for="(headerWithBgRight, i) in headerWithBgRights"
      :key="i" 
    class="py-8 md:py-28">
        ...
        <div class="flex flex-wrap items-center -mx-4">
          <div class="w-full md:w-1/2 lg:px-4">
            <div class="relative mx-auto md:mr-0 max-w-max">
              <img
                :src="headerWithBgRight.photo"
                class="relative w-full py-4 sm:my-4 lg:w-3/4 mx-auto"
                alt=""
              />
            </div>
          </div>
          <div class="w-full text-center md:text-left md:w-1/2 md:mb-0 sm:px-3 px-8 md:px-16">
            <h2
...
<script>
export default {
  name: "HeaderWithBgRight",
  props: ["headerWithBgRights"],
};
</script>

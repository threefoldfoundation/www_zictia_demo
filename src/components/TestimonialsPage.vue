<template>
  <div class="navigation-wrapper">
    <div
      ref="container"
      class="keen-slider mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16"
    >
      <div class="keen-slider__slide number-slide1">
        <blockquote class="rounded-lg bg-gray-50 p-6 shadow-lg sm:p-8">
          <div class="flex items-center gap-4">
            <img
              alt="Man"
              src="../assets/imgs/home/Ellipse1.png"
              class="h-14 w-14 rounded-full object-cover"
            />

            <div>
              <div class="flex justify-center gap-0.5 text-blue-800">
                <svg
              ...
              <p class="mt-0.5 text-lg font-medium text-gray-900">ZATICO</p>
            </div>
          </div>
      ...
      <div class="keen-slider__slide number-slide2">
        <blockquote class="rounded-lg bg-gray-50 p-6 shadow-lg sm:p-8">
          <div class="flex items-center gap-4">
            <img
              alt="Man"
              src="../assets/imgs/home/Ellipse2.png"
              class="h-14 w-14 rounded-full object-cover"
            />
            ...
            <div>
              ...
              <p class="mt-0.5 text-lg font-medium text-gray-900">OR-TMSMIM</p>
            </div>
          </div>
